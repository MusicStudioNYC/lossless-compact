...
| 2026-09-20 | Record Jev cassettes and calibrate threshold / wording (`npm run eval -- --record`) | No `TYPESAFE_API_KEY` on this machine; upstream #54 says issuance is opaque |
...
| 2026-09-20 | Label a handful of real sessions (`labels.json`) for real-session fidelity numbers | Owner's call: manual vs model-assisted labelling cost |
